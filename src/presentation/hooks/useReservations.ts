...
export interface UseReservationsResult {
  ...
  isLoading: boolean;
  error: string | null;
  getById: (_id: string) => Promise<Reservation | null>;
  create: (_data: CreateReservationData) => Promise<Reservation | null>;
  update: (
    _id: string,
    _data: UpdateReservationData,
  ) => Promise<Reservation | null>;
  confirm: (_id: string, _confirmedBy: string) => Promise<Reservation | null>;
  cancel: (_id: string, _reason?: string) => Promise<Reservation | null>;
  markSeated: (_id: string, _sessionId: string) => Promise<Reservation | null>;
  markNoShow: (_id: string) => Promise<Reservation | null>;
...
export function useReservations(
  ...
  const confirm = useCallback(
    async (id: string, confirmedBy: string): Promise<Reservation | null> => {
      setError(null);
  ...
  const markSeated = useCallback(
    async (id: string, sessionId: string): Promise<Reservation | null> => {
      setError(null);
