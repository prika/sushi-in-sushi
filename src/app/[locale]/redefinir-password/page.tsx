...
export default function RedefinirPasswordPage() {
  ...
  const t = useTranslations("redefinirPassword");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Detect whether this is a staff or customer account and redirect
      ...
      <div className="w-full max-w-sm">
        ...
        {success ? (
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-6 text-center">
            <svg
              className="w-12 h-12 text-amber-400 mx-auto mb-3 animate-spin"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p className="text-amber-400 text-sm">{t("verifying")}</p>
          </div>
        ) : (
