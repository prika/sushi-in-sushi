-- =============================================
-- SUSHI IN SUSHI - BASE SCHEMA (Part 0)
-- =============================================
-- Run this FIRST, before consolidated-dev-part1.sql
--
...
-- Project: cezyuevhqdgvclneobgt (dev)
-- =============================================
...
AND table_name IN ('categories', 'tables', 'products', 'sessions', 'orders')
ORDER BY table_name;
